...
export default class NameForm extends React.Component {
  ...
  handleSubmit = event => {
    ...
    console.log(
      "========>event.nativeEvent >> get email input field value",
      event.nativeEvent.target.email.value
    );
    console.log(
      "========>event.nativeEvent >> get password input field value",
      event.nativeEvent.target.password.value
    );
...
/**
 * input element properties find below:
 * name: identity inside a form element
 * value: changed value (mandatory implement onClick)
 * onClick: provides updated event
