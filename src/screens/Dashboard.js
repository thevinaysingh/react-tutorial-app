...
class Dashboard extends Component {
  ...
  useOfBlock = () => {
    ...
    this.props.history.block((location, action) => {
      ...
      if (action === "POP" && location.pathname.startsWith("/signup")) return 'Are you sure you want to leave this page?';
    });
  }
  ...
  render() {
    ...
    return (
      <div className="default-container">
          <span>This is Dashboard page for {this.props.match.params.username}</span>
